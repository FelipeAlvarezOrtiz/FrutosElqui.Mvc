        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdCategoria = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreCategoria = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdComuna = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreComuna = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreCuenta = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DescripcionCuenta = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CicloFacturacion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DiaFacturacion = table.Column<int>(type: "int", nullable: false),
                    MontoDeclarado = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
